...
@Component({
  selector: 'app-certificate-with-title',
  templateUrl: './certificate-with-title.component.html',
  styleUrls: ['./certificate-with-title.component.scss']
})
export class CertificateWithTitleComponent implements OnInit {
