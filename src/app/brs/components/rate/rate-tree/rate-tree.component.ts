...
@Component({
  selector: 'app-rate-tree',
  templateUrl: './rate-tree.component.html',
  styleUrls: ['./rate-tree.component.scss'],
  providers: [RateService]
})
export class RateTreeComponent implements OnInit, AfterViewChecked, AfterViewInit {
  ...
  constructor(private rateService: RateService,
    ...
    this.rateService.findAllGroup().subscribe(
      x => {
  ...
  filterTree() {
    ...
    if (this.filterText) {
      ...
      let res = this.rateService.filter(treeData, this.filterText);
